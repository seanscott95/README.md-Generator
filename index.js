...
// Creates a README file using the file system writeFile()
...
// Inquirer is used to prompt user input for application
// Creates a detailed readme file using the writeToFile function with user input from inquirer
function init() {
    inquirer.prompt([
        {
            type: 'input',
